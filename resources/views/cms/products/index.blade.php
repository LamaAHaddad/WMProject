              ...
              <table class="table table-striped table-bordered">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="btn-group">
                        <a href="{{route('products.edit',$product->id)}}" type="button" class="btn btn-warning btn-circle">
                          <i class="fas fa-edit"></i>
                        </a>
                          <a href="#" onclick="confirmDelete('{{$product->id}}' , this)" class="btn btn-danger btn-circle">
