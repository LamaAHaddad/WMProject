              ...
              <table class="table table-striped table-bordered">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="btn-group">
                        <a href="{{route('cities.edit',$city->id)}}" type="button" class="btn btn-warning btn-circle">
                          <i class="fas fa-edit"></i>
                        </a>
                          <a href="#" onclick="confirmDelete('{{$city->id}}' , this)" class="btn btn-danger btn-circle">
